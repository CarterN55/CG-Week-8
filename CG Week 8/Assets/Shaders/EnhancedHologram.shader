Shader "Carter/URP/EnhancedHologram"
{
    Properties
    {
        ...
        _LineSpeed ("Line Speed", Float) = 50.0  // Speed of the scanning lines (Made it faster)
        _LineFrequency ("Line Frequency", Float) = 1000.0  // Frequency of scan lines
